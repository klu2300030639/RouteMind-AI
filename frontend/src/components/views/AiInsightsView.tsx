...
import { LineChart, Zap, CheckCircle2 } from 'lucide-react';
...
export default function AiInsightsView() {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">AI Decision Insights and ROI Analytics</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <KpiCard title="Monthly Cost Savings" value="$14,250.00" change="+18%" icon={<LineChart className="w-5 h-5" />} subtitle="Fuel and overtime reduction" />
      </div>
    </div>
  );
}
