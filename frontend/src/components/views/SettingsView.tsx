...
export default function SettingsView({ isDark, setIsDark }: SettingsViewProps) {
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        <h2 className="text-2xl font-extrabold text-slate-900 dark:text-slate-100 tracking-tight">System and Dispatch Settings</h2>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl p-6 shadow-xs space-y-6">
        <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
          <div>
            <h3 className="font-extrabold text-sm text-slate-900 dark:text-slate-100">Interface Color Theme</h3>
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-800 font-bold text-xs flex items-center gap-2 cursor-pointer bg-slate-50 dark:bg-slate-950 text-slate-700 dark:text-slate-300"
          >
